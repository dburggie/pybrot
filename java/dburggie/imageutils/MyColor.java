...
public class MyColor
{
	...
	/** Initialize MyColor object to given rgb values. */
	...
	/** Returns new MyColor instance that exactly copies the caller. */
	public MyColor dup()
	{
		return new MyColor(red, green, blue, alpha);
	}
	
	/** Copies the rgba values from the parameter into the caller. */
	public MyColor copy(MyColor c)
	{
	...
	public boolean equals(MyColor c)
	{
		int [] a = p();
		int [] b = c.p();
	...
	public MyColor setRGB( double r, double g, double b )
	{
	...
	public MyColor setRGBA( double r, double g, double b, double a)
	{
		red = r; green = g; blue = b; alpha = a;
		return this;
	}
	
	public MyColor setRGBA( int r, int g, int b, int a)
	{
		red = r / 256.0;
		green = g / 256.0;
		blue = b / 256.0;
	...
	/** See notice for setRGB method. */
	public MyColor setalpha( double a )
	{
		alpha = a; return this;
	}
	...
	public MyColor copyARGB(int argb)
	{
		int r,g,b,a;
		b = (0x0ff & ( argb >>>  0 ));
		g = (0x0ff & ( argb >>>  8 ));
